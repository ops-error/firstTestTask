...
type Payment struct {
	...
	Delivery_cost int64  `db:"delivery_cost" json:"delivery_cost"`
	Goods_total   int64  `db:"goods_total" json:"goods_total"`
	Custom_fee    int64  `db:"custom_fee" json:"custom_fee"`
}
